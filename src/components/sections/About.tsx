            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Cuxhaven, Alemanha</p>
                  <p className="text-gray-600">CEP: XXXXX</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+49 XXXX XXXXX</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-gray-800 font-medium mb-1">E-mail</h4>
                  <p className="text-gray-600">contato@brunasilva.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="text-gray-800 font-medium mb-1">Redes Sociais</h4>
                  <div className="flex space-x-4 mt-2">
                    <a href="#" className="text-[#FFB6C1] hover:text-[#FF69B4] transition-colors duration-300">
